  ...
  try {
    ...
    //    → 同じ内容を 1 画面の HTML に要約させ、判断の入口をそちらに移す。
      ...
      reason =
        ...
        '- 中身は「全体像の図／決めてほしいこと（最大3つ）／何が変わるか／触る範囲／リスクと戻し方」\n' +
        '- **図を必ず1つ入れる**。登場人物・モノを箱で置き、矢印に動詞のラベルを振った線画にする\n' +
        '  図はインライン SVG で描く（mermaid・外部読み込みは file:// で開くと描画されないため不可）\n' +
        '  描き方の基準は eli5 スキルの「図のスタイル」「絵記号の語彙」に揃える\n' +
